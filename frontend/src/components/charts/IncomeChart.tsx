          ...
          >
            {groupedData.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Tooltip */}
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity mb-1 px-2 py-1 bg-emerald-800 text-white text-xs rounded shadow-lg whitespace-nowrap z-10">
