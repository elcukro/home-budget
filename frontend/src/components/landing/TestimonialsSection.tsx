...
const testimonials = [
  {
    ...
    text: 'W 3 miesiące spłaciłam pierwszy kredyt i zbudowałam fundusz awaryjny 4000 zł. Pierwszy raz widzę światełko w tunelu.',
    avatar: 'M',
  ...
  },
  {
    ...
    text: 'Przez 20 lat nie oszczędzałem na emeryturę. FiredUp pokazał mi IKE i IKZE - w 4 miesiące założyłem konta i wpłaciłem pierwsze 8000 zł.',
    avatar: 'M',
  ...
  },
  {
    ...
    text: 'Programista z dobrą pensją, ale zero oszczędności. W 4 miesiące z metodą kuli śnieżnej spłaciłem kartę kredytową i chwilówkę. Zostały 2 kredyty!',
    avatar: 'J',
  ...
  },
  {
    ...
    text: 'Prowadziłam firmę i mieszałam finanse prywatne z firmowymi. FiredUp w 2 miesiące nauczył mnie dyscypliny. Wreszcie wiem ile zarabiam naprawdę!',
    avatar: 'Z',
