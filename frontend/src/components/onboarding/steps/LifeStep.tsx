...
export default function LifeStep({
  ...
  return (
    ...
    >
      ...
      <div className={`grid gap-4 ${shouldAskPartnerBudget ? 'sm:grid-cols-2' : ''}`}>
        <FieldGroup
          label={
            <>
        ...
        {shouldAskPartnerBudget && (
          <div className="flex items-center justify-between rounded-lg border border-muted/60 bg-muted/30 px-4 py-3 self-end">
            <div>
      ...
      <div className={`grid gap-4 ${data.childrenCount > 0 ? 'sm:grid-cols-2' : ''}`}>
        <FieldGroup
          label={
            <>
      ...
      <div className={`grid gap-4 ${data.housingType === 'mortgage' ? 'sm:grid-cols-2' : ''}`}>
        <FieldGroup
          label={
            <>
        ...
        {data.housingType === 'mortgage' && (
          <div className="flex items-center justify-between rounded-lg border border-primary/20 bg-primary/5 px-4 py-3 self-end">
            <div>
              <p className="text-sm font-medium text-primary">
      ...
      {(data.employmentStatus === 'employee' || data.employmentStatus === 'contract' || data.employmentStatus === 'freelancer') && (
        <div className={`grid gap-4 ${data.employmentStatus === 'employee' ? 'sm:grid-cols-2' : ''}`}>
